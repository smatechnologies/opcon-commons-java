...
public class LocalDateTimeSerializerTest {
    ...
    public void test02Date() throws ParseException, SerializeException {
        ...
        Assert.assertEquals("1985-11-26T21:00:00Z", serializer.serialize(getLocalDateTime(1985, 10, 26, 21, 0, 0, 0)));
        Assert.assertEquals("2015-11-21T19:28:00.015Z", serializer.serialize(getLocalDateTime(2015, 10, 21, 19, 28, 0, 15)));
        Assert.assertEquals("1955-12-12T06:38:00.15Z", serializer.serialize(getLocalDateTime(1955, 11, 12, 6, 38, 0, 150)));

        TimeZone.setDefault(TimeZone.getTimeZone("CET"));

        Assert.assertEquals("1985-11-26T21:00:00+01:00", serializer.serialize(getLocalDateTime(1985, 10, 26, 21, 0, 0, 0)));
        Assert.assertEquals("2015-11-21T19:28:00.015+01:00", serializer.serialize(getLocalDateTime(2015, 10, 21, 19, 28, 0, 15)));
        Assert.assertEquals("1955-12-12T06:38:00.15+01:00", serializer.serialize(getLocalDateTime(1955, 11, 12, 6, 38, 0, 150)));
    }
